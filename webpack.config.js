...
module.exports = function (env, argv) {
    ...
    return {
        ...
        module: {
            ...
            {
                test: /\.sass$/,
                loaders: argv.mode === 'development' ? ['style-loader', 'resolve-url-loader', 'css-loader?sourceMap', 'postcss-loader', 'postcss-sass-loader', 'sass-loader?sourceMap'] : [MiniCssExtractPlugin.loader, 'css-loader', 'postcss-loader', 'sass-loader']
            }
                // {
